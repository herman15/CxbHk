...
class LineTimeline(object):
    ...
    @loggedIn
    def getGroupPost(self, mid, postLimit=20, commentLimit=1, likeLimit=1):
        params = {'postLimit': postLimit, 'homeId': mid, 'commentLimit': commentLimit, 'likeLimit': likeLimit, 'sourceType': 'TALKROOM'}
